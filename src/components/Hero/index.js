...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="flex-1 text-center text-sm md:text-base md:self-start md:my-16 order-1 md:-order-last">
        ...
        <p className="max-w-md mx-auto">{personalInfo.heroText}</p>

        <div className="flex mt-3 flex-col md:space-y-0 space-y-3  my-1 md:my-3 md:justify-center items-center md:flex-row ">
          <Link
            rel="noreferrer"
            target="_blank"
            to="/view-resume"
